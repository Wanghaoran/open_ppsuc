...
<title>登录 - 中国人民公安大学网络学院后台管理系统</title>
<link href="__PUBLIC__/admin/dwz/themes/css/login.css" rel="stylesheet" type="text/css" />
<script src="__PUBLIC__/admin/dwz/js/jquery-1.7.2.min.js" type="text/javascript"></script>
...
<div id="login">
	<div id="login_header">
		<h1 class="login_logo">
			<a href="__APP__"><img src="__PUBLIC__/admin/dwz/themes/default/images/login_logo.png" /></a>
		</h1>
	...
	<div id="login_content">
		...
		<div class="login_banner"><img src="__PUBLIC__/admin/dwz/themes/default/images/login_banner.jpg" /></div>
	...
	<div id="login_footer">
		Copyright &copy; 2013 中国人民公安大学网络学院 Inc. All Rights Reserved.
	</div>
</div>
