...
<div class="pageContent">
	<div class="panelBar">
	  <ul class="toolBar">
	    <li><a class="add" href="__APP__/news/addcategory" target="dialog" mask="true"><span>新增</span></a></li>
	    <li class=""><a class="delete" href="__APP__/news/delcategory/navTabId/news_category" posttype="string" rel="ids" target="selectedTodo" title="确实要删除这些记录吗?" warn="请选择分类"><span>删除</span></a></li>
	    <li><a class="edit" href="__APP__/news/editcategory/id/{sid_role}" target="dialog" mask="true" warn="请选择分类"><span>编辑</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><tr target="sid_role" rel="<?php echo ($r["id"]); ?>">
		  <td><input type="checkbox" value="<?php echo ($r["id"]); ?>" name="ids"></td>
			  ...
			  <td style="background-color:<?php echo ($r["color"]); ?>;"></td>
