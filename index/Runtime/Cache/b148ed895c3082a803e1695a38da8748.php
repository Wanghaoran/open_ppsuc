...
<div class="container">
  <h2 class="info-section-title">新闻动态</h2>
  <div class="well well-small">
			...
			<span class="pull-right text-info"><?php echo (date("Y-m-d", $rn["addtime"])); ?></span> <strong style="color:<?php echo ($rn["color"]); ?>;">【<?php echo ($rn["ncname"]); ?>】</strong>&nbsp;&nbsp;<a style="color:black;" href="__ROOT__/news/info/id/<?php echo ($rn["id"]); ?>"><?php echo ($rn["title"]); ?></a>
